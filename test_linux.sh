...
sudo bash -c 'echo 1 > /sys/kernel/debug/tracing/events/sched/sched_switch/active'
sudo bash -c 'cat /sys/kernel/debug/tracing/trace_pipe' | head -n 1000 > test/linux/trace_affine.txt
sudo bash -c 'echo 0 > /sys/kernel/debug/tracing/events/sched/sched_switch/active'
./test/linux/plot_ftrace_sched_switch.py <./test/linux/trace_affine.txt >./test/linux/trace_affine.json
...
sudo bash -c 'echo 0 > /sys/kernel/debug/tracing/events/sched/sched_switch/active'
./test/linux/plot_ftrace_sched_switch.py <./test/linux/trace_antiaffine.txt >./test/linux/trace_antiaffine.json
